            ...
            <table class="table-fixed w-full">
                <thead class="bg-gray-500">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-white">Nis</th>
                        <th class="px-4 py-2 text-white">Nama</th>
                        <th class="px-4 py-2 text-white">JK</th>
                        <th class="px-4 py-2 text-white">Tempat Lahir</th>
                        <th class="px-4 py-2 text-white">Tanggal Lahir</th>
                        <th class="px-4 py-2 text-white">Alamat</th>
                        <th class="px-4 py-2 text-white">Asal Sekolah</th>
                        <th class="px-4 py-2 text-white">kelas</th>
                        <th class="px-4 py-2 text-white">Jurusan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($student->temp_lahir); ?></td>
                        <td><?php echo e($student->tgl_lahir); ?></td>
                        <td><?php echo e($student->alamt); ?></td>
                        <td><?php echo e($student->asal_sekolah); ?></td>
                        <td><?php echo e($student->kelas); ?></td>
                        <td><?php echo e($student->jurusan); ?></td>
                        <td>
                            <button wire:click="edit(<?php echo e($student->id); ?>)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Edit
                            </button>
                            <button wire:click="delete(<?php echo e($student->id); ?>)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                            Delete
                            </button>
                        </td>
                    </tr>
